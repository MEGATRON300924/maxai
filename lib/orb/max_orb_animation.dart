...
class MaxOrbAnimationConfig {
  ...
  factory MaxOrbAnimationConfig.fromState(
    MaxOrbState state,
  ) {
    ...
    switch (state) {
      ...
      case MaxOrbState.idle:
        ...
        return const MaxOrbAnimationConfig(

          type: MaxOrbAnimationType.breathing,
      ...
      case MaxOrbState.listening:
        ...
        return const MaxOrbAnimationConfig(
          ...
          type: MaxOrbAnimationType.waveform,
      ...
      case MaxOrbState.thinking:
        ...
        return const MaxOrbAnimationConfig(
          ...
          type: MaxOrbAnimationType.liquid,
      ...
      case MaxOrbState.speaking:
        ...
        return const MaxOrbAnimationConfig(
          ...
          type: MaxOrbAnimationType.pulse,
      ...
      case MaxOrbState.success:
        ...
        return const MaxOrbAnimationConfig(
          ...
          type: MaxOrbAnimationType.ripple,
      ...
      case MaxOrbState.sos:
        ...
        return const MaxOrbAnimationConfig(
          ...
          type: MaxOrbAnimationType.heartbeat,
      ...
      case MaxOrbState.syncing:
        ...
        return const MaxOrbAnimationConfig(
          ...
          type: MaxOrbAnimationType.rotation,
      ...
      case MaxOrbState.sleep:
        ...
        return const MaxOrbAnimationConfig(
          ...
          type: MaxOrbAnimationType.sleeping,
