...
class MaxOrbParticlesPainter
  ...
  final List<MaxOrbParticle> particles =
      const [
  ...
  bool _shouldShowParticles() {
    ...
    return state ==
            MaxOrbState.thinking ||

        state ==
            MaxOrbState.wakeDetected ||
  ...
  @override
  bool shouldRepaint(
    covariant MaxOrbParticlesPainter oldDelegate,
  ) {
