...
class MaxOrbPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawOuterGlow(canvas, center, radius, theme);
    _drawCore(canvas, center, radius, theme);
    _drawReflection(canvas, center, radius);
  }
  ...
  void _drawCore(
    ...
    final gradient = RadialGradient(
      ...
      colors: [
        theme.secondary,
        theme.primary,
        theme.primary.withValues(alpha: .7),
      ],
    );
  ...
  void _drawReflection(Canvas canvas, Offset center, double radius) {
    final paint = Paint()
  ...
  @override
  bool shouldRepaint(covariant MaxOrbPainter oldDelegate) {
